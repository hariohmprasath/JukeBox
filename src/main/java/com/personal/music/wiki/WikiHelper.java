...
public class WikiHelper {
    ...
    public static final String WIKI_BASE_URL = "https://en.wikipedia.org/wiki/%s";
    public static final String WIKI_PARSER = "https://en.wikipedia.org/w/api.php?action=query&list=search&srsearch=%s&format=xml";
